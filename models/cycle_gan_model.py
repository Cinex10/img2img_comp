...
class CycleGANModel(BaseModel):
    ...
    def get_correct_attr(self,name):
        return getattr(self.gen, 'net' + name) if name.startswith('G') else getattr(self.desc, 'net' + name)
    ...
    def backward_G(self):
        ...
        # GAN loss D_A(G_A(A))
        self.loss_G_A = self.criterionGAN(self.desc.netD_A(self.fake_B), True)
        # GAN loss D_B(G_B(B))
        self.loss_G_B = self.criterionGAN(self.desc.netD_B(self.fake_A), True)
